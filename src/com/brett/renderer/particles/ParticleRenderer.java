...
public class ParticleRenderer {
	...
	public static void updateInternalData(ParticleRenderer renderer, int MAX_INSTANCES) {
		ParticleRenderer.MAX_INSTANCES = MAX_INSTANCES;
		ParticleRenderer.buffer = BufferUtils.createFloatBuffer(MAX_INSTANCES * INSTANCE_DATA_LENGTH);
		renderer.loader.deleteVBO(renderer.vbo);
		renderer.vbo = renderer.loader.createEmptyVBO(INSTANCE_DATA_LENGTH * MAX_INSTANCES);
	}
