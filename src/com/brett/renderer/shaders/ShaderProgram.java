...
/**
 * @author brett
 * ShaderProgram is the base of all of my shaders
 * It handles loading and running of shaders.
 */
public abstract class ShaderProgram {
	...
	/**
	 * The function allows you to grab the uniform locations inside the shader,
	 * and reduce them to an integer pointer. This pointer can then be used at a
	 * later time to load information into the shader, be it a matrix or a color or any OpenGL type.
	 */
	protected abstract void getAllUniformLocations();
	
	/**
	 * finds the uniform location by name and returns a integer pointer to its location
	 */
	...
	/**
	 * This function is to be used with the bind attribute function to assign the inputs to shaders.
	 * binding attributes need to occur in this method <b>alone</b>.
	 */
	protected abstract void bindAttributes();
	
	/**
	 * The function takes an attribute position and assigns it to the string name set in the shader file. <br>
	 * <b>What's an attribute position?</b> <br>
	 * Well, remember when we set: <br>
	 * <code>this.storeDataInAttributeList(attribute, dimensions, float[]);</code> <br>
	 * in the loader class? Well the attribute number is the one you assign here. <br>
