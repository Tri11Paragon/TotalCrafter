...
public class SuperNoise extends NoiseFunction {
	
	public SuperNoise(long seed) {
		super(seed);
		random.setSeed(seed);
		for (int i=0; i < 256 ; i++) {p[256+i] = p[i] = permutation[i]; }
	}
	
	public static float AMPLITUDE = 120f;
	...
	public float getInterpolatedNoise(float x, float z) {
        ...
        //return (float) (noise(x/128.0, seed*1.28384934d, z/128.0) * 40 + 60);
	}
